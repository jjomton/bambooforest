...
export const BoardList: React.FC = () => {
  ...
  return (
    <Layout>
      {/* 검색 바 및 글쓰기 버튼 상단 영역 */}
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between mb-6 sm:mb-8">
        ...
        <button
          ...
          className="w-full sm:w-auto flex items-center justify-center gap-1.5 px-5 py-2.5 bg-brand-blue hover:bg-brand-blue-hover text-white rounded-bamboo-input font-bold text-sm shadow-soft transition-colors shrink-0 cursor-pointer"
        >
